            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header" style="justify-content: space-between;">
                        ...
                        <a href="{{route('admin-etab.actualite.index')}}" class="btn btn-primary">Liste des actualites</a>
                    </div>
                    <div class="card-body">
                        <form action="{{route('admin-etab.actualite.update',['actualite' => $actualite->id])}}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="titre" value="{{old('titre',$actualite->titre)}}" class="form-control {{ $errors->has('titre') ? 'is-invalid' : '' }}">
                                        @if($errors->has('titre'))
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="published_at" value="{{old('published_at',$actualite->published_at)}}" class="form-control {{ $errors->has('published_at') ? 'is-invalid' : '' }}">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="finished_at" value="{{old('finished_at',$actualite->finished_at)}}" class="form-control {{ $errors->has('published_at') ? 'is-invalid' : '' }}">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="description" name="description" class="summernote">{{old('description',$actualite->description)}}</textarea>
