...
<script>
    ...
    $(document).ready(function () {
        $('#etudiant-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin-etab.payment.master.filiere.students',['filiere' => $filiere->id]) }}",
            columns: [
                {
                    data: null,
                    name: 'nom',
                ...
                { data: 'etat_payment', name: 'etat_payment' },
                {
                    ...
                    searchable: false,
                    render: function (data, type, row) {
                        let btnShow = '<a href="/admin-etab/payment/master/filiere/' + filiereId + '/student/' + data + '/show" class="btn btn-info btn-sm mr-1">Afficher</a>';
                        return btnShow;
            ...
            drawCallback: function () {
                $('#etudiant-table_paginate .pagination li').each(function() {
                    ...
                    var href = "{{ route('admin-etab.payment.master.filiere.students',['filiere' => $filiere->id]) }}?page=" + pageNum;
