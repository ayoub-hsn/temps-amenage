    ...
    <div class="page-wrapper">
        ...
        <div class="profile-grid">
            ...
            <div class="glass-card form-card">
                ...
                <form action="{{ route('admin-etab.payment.licence.filiere.student.store', ['filiere' => $etudiant->filiere, 'etudiant' => $etudiant->id]) }}"
                    method="POST"
...
<div class="main-content">
    <section class="profile-container">
        <div class="profile-card">
            ...
            {{-- Profile Header --}}
            <div class="profile-header">
                <h2>Candidature Licence (Accès S5)</h2>
            ...
            {{-- Parcours Licence --}}
            <div class="section-card">
                <div class="section-title">Parcours Bac+2</div>
                <div class="detail-item"><span class="detail-label">Diplome:</span> <span class="detail-value">{{ $etudiant->diplomedeug }}</span></div>
                <div class="detail-item"><span class="detail-label">Établissement:</span> <span class="detail-value">{{ $etudiant->etblsmtdeug }}</span></div>
                <div class="detail-item"><span class="detail-label">Spécialité:</span> <span class="detail-value">{{ $etudiant->specialitedeug }}</span></div>
                <div class="detail-item"><span class="detail-label">Date d'obtention:</span> <span class="detail-value">{{ \Carbon\Carbon::parse($etudiant->date_obtention_deug)->format('d/m/Y') }}</span></div>
                <div class="detail-item"><span class="detail-label">Mention:</span> <span class="detail-value">{{ $etudiant->mentiondeug }}</span></div>
                <div class="detail-item"><span class="detail-label">Moyenne:</span> <span class="detail-value">{{ $etudiant->moyenne_deug }}</span></div>
            </div>

            {{-- Filière Licences (Accès S5) --}}
            <div class="section-card">
                <div class="section-title">Filière Licences (Accès S5)</div>
