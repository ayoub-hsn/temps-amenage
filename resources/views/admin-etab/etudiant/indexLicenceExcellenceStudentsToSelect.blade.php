...
<script>
    ...
    $(document).ready(function () {
        $('#etudiant-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin-etab.filiere.licenceExcellence.etudiants.listToselect',['filiere' => $filiere->id]) }}",
            columns: [
                {
                    data: null,
                    name: 'nom',
                ...
                { data: 'verif', name: 'verif' },
                {
                    ...
                    searchable: false,
                    render: function (data, type, row) {
                        return '<a href="/admin-etab/filiere/' + filiereId + '/licenceExcellence/etudiant/' + data + '" class="btn btn-info btn-sm mr-1">Afficher</a>';
                    }
                }
            ],
            ...
            drawCallback: function () {
                $('#etudiant-table_paginate .pagination li').each(function() {
                    ...
                    var href = "{{ route('admin-etab.filiere.licenceExcellence.etudiants.listToselect',['filiere' => $filiere->id]) }}?page=" + pageNum;
