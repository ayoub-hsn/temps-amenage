        ...
        <div class="profile-grid">
            ...
            <div class="glass-card">
                ...
                <div class="profile-body">
                    ...
                    <div class="info-row"><span class="info-label">Série</span><span class="info-value">{{ $etudiant->serie }}</span></div>
                    <div class="info-row"><span class="info-label">Moyenne</span><span class="info-value">{{ $etudiant->moyenne_bac }}</span></div>

                    <div class="section-title">Filière Licences (Accès S1)</div>
            ...
            <div class="glass-card form-card">
                ...
                <form action="{{ route('admin-etab.payment.bachelier.filiere.student.store', ['filiere' => $etudiant->filiere, 'etudiant' => $etudiant->id]) }}"
                    method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <select name="semestre" 
                            ...
                            <option value="S1-S2" {{ old('semestre') == 'S1-S2' ? 'selected' : '' }}>S1-S2</option>
                            <option value="S3-S4" {{ old('semestre') == 'S3-S4' ? 'selected' : '' }}>S3-S4</option>
                        </select>
                        @error('semestre')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
