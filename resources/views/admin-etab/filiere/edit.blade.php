        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin-etab.filiere.update',['filiere' => $filiere->id])}}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nom_abrv" value="{{old('nom_abrv',$filiere->nom_abrv)}}" class="form-control {{ $errors->has('nom_abrv') ? 'is-invalid' : '' }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nom_complet" value="{{old('nom_complet',$filiere->nom_complet)}}" class="form-control {{ $errors->has('nom_complet') ? 'is-invalid' : '' }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="responsable_id" class="form-control select2 {{ $errors->has('responsable_id') ? 'is-invalid' : '' }}" id="responsable_id">
                                                    ...
                                                    @foreach ($responsables as $responsable)
                                                        <option value="{{$responsable->id}}" {{ old('responsable_id',$filiere->responsable_id) == $responsable->id ? 'selected' : '' }}>{{ $responsable->name }}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="type" class="form-control select2 {{ $errors->has('type') ? 'is-invalid' : '' }}" id="type">
                                            ...
                                            @foreach(App\Models\Filiere::TYPE as $key => $label)
                                                <option value="{{$key}}" {{ old('type',$filiere->type) == $key ? 'selected' : '' }}>{{$label}}</option>
                                            @endforeach
                                        </select>
                                        @if($errors->has('type'))
                                            <div class="invalid-feedback">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="description" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description">{{old('description',$filiere->description)}}</textarea>
...
<div class="modal fade" id="createResponsableModal" tabindex="-1" role="dialog" aria-labelledby="formModal"
    ...
    <script>
        $(document).ready(function () {
            ...
            var errr = {{ $errors->any() ? 'true' : 'false' }};
            console.log('hi')
            console.log(errr)
