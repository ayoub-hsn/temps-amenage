                                        ...
                                        <div class="card shadow-lg rounded-xl filiere-card">
                                            ...
                                            <div class="card-body d-flex flex-column">
                                                ...
                                                <div class="d-flex justify-content-between mt-4">
                                                    ...
                                                    <a href="{{ route('admin-etab.filiere.bachelier.etudiants.index', $filiere->id) }}" class="btn btn-light btn-lg" data-toggle="tooltip" data-placement="top" title="Étudiants Postulants">
