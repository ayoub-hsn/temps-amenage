<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        {{-- <li class="dropdown {{ Route::currentRouteNamed('admin-etab.filiere.licence.index') ? 'active' : '' }}">
          <a href="{{route('admin-etab.filiere.licence.index')}}" class="nav-link"><i data-feather="file-text"></i><span>Licence</span></a>
        </li> --}}
        {{-- <li class="dropdown {{ Route::currentRouteNamed('admin-etab.filiere.licence.acceeouvert.index') ? 'active' : '' }}">
          <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="settings"></i><span>Licence</span></a>
          <ul class="dropdown-menu">
            <li class="{{ Route::currentRouteNamed('admin-etab.filiere.licence.acceeouvert.index') ? 'active' : '' }}"><a href="{{ route('admin-etab.filiere.licence.acceeouvert.index') }}">Accees Ouvert</a></li>
            <li class="{{ Route::currentRouteNamed('admin-etab.filiere.licence.acceeouvert.index') ? 'active' : '' }}"><a href="{{ route('admin-etab.filiere.licence.acceeouvert.index') }}">Accees Regule</a></li>
          </ul>
        </li> --}}
