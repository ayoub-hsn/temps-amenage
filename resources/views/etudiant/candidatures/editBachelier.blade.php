                  ...
                  <div class="padding-20">
                    ...
                    <div class="tab-content tab-bordered" id="myTab3Content">
                        <div class="tab-pane fade show active" id="identite" role="tabpanel" aria-labelledby="home-tab2">
                            <form method="POST" action="{{route('etudiant.candidatures.bachelier.identite.update',['etudiant' => $etudiant->id])}}">
                                @csrf
                                @method('PUT')
                        ...
                        <div class="tab-pane fade" id="informationacademique" role="tabpanel" aria-labelledby="profile-tab2">
                            <form method="POST" action="{{route('etudiant.candidatures.bachelier.academique.update',['etudiant' => $etudiant->id])}}">
                                @csrf
                                @method('PUT')
                                <div class="card-header">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step="0.01" name="moyenne_bac" value="{{ old('moyenne_bac', $etudiant->moyenne_bac) }}" class="form-control {{ $errors->has('moyenne_bac') ? 'is-invalid' : '' }}">
                                                    @if($errors->has('moyenne_bac'))
                                                        <div class="invalid-feedback">{{ $errors->first('moyenne_bac') }}</div>
                                                    @endif
                                                </div>
                                            </div>
                        ...
                        <div class="tab-pane fade" id="choixFiliere" role="tabpanel" aria-labelledby="profile-tab2">
                            <form method="POST" action="{{ route('etudiant.candidatures.bachelier.choixFiliere.update', ['etudiant' => $etudiant->id]) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="card-body">
                                    <div class="container">
                                        ...
                                        @if($etablissement->multiple_choix_filiere_bachelier == 0)
                                            {{-- Single Choice --}}
                                            @php
