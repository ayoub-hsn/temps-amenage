                    ...
                    <div class="card-body">
                        ...
                        {{-- @if ($etablissement->multiple_choix_filiere_master == 1)    
                            <div class="d-flex justify-content-center mb-3">
                                <a href="{{ route('admin-filiere.filiere.multiplechoix.master.etudiants.excel.download',['etablissement' => $etablissement->id]) }}" class="btn btn-primary">Télécharger la liste de tous les étudiants postulants</a>
                            </div>
                        @endif --}}
                        @if($filieres->isEmpty())
                                        ...
                                        <div class="card shadow-lg rounded-xl filiere-card">
                                            ...
                                            <div class="card-body d-flex flex-column">
                                                ...
                                                <div class="d-flex justify-content-between mt-4">
                                                    ...
                                                    <a href="{{ route('admin-filiere.filiere.master.etudiants.index', $filiere->id) }}" class="btn btn-light btn-lg" data-toggle="tooltip" data-placement="top" title="Étudiants Postulants">
