...
<head>
    ...
    <style>
        ...
        /* Bloc étudiant non-fonctionnaire */
        .student-info-card {
            display: flex;
            align-items: center;
            gap: 15px;
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                                ...
                                <div class="documents">
                                    ...
                                    <div class="preview-container">
                                        ...
                                        @if ($etablissement->show_bac_input_master)
                                            <div class="preview-row">
                                                <div class="preview-item" style="width: 710px;"><!-- style="width: 710px;" -->
                                        ...
                                        @if ($etablissement->show_licence_input_master)
                                            <div class="preview-row">
                                                <div class="preview-item" style="width: 710px;">
                                                    <img src="{{ route('secure.file', ['hashedPath' => urlencode(Crypt::encryptString($etudiant->path_licence))]) }}" alt="Diplome licence">
                                                    <a href="{{ route('secure.file', ['hashedPath' => urlencode(Crypt::encryptString($etudiant->path_licence))]) }}" target="_blank">Diplome Licence</a>
                                                </div>
                                            </div>
                                        @endif
                                        ...
                                        @if ($etablissement->show_attestation_no_emploi_input_master)
                                            <div class="preview-row">
                                                <div class="preview-item" style="width: 710px;">
                                                    <img src="{{ route('secure.file', ['hashedPath' => urlencode(Crypt::encryptString($etudiant->path_attestation_non_emploi))]) }}" alt="Attestation non emploi">
                    ...
                    <!-- Action Section: Validate or Reject Student -->
                    <div class="row mt-5">
                        <div class="col-lg-10 mx-auto">
                            <div class="validation-card">
                                <div class="validation-header">
                                    <h2>Validation de l'Étudiant</h2>
                                    <small class="d-block mt-1">Université Hassan Premier de Settat - {{ $etablissement->nom_abrev }}</small>
                                </div>
                    
                                <form id="validationForm" action="{{ route('admin-filiere.filiere.etudiant.validation', ['filiere' => $filiere->id,'etudiant' => $etudiant->id]) }}" method="POST">
                                    @csrf
                                    @method('POST')
                    
                                    <div class="form-floating mb-4">
                                        <textarea name="motif" id="motif" class="form-control" placeholder="Entrez le motif ici..." style="height: 120px"></textarea>
                                        <label for="motif">Motif du rejet (obligatoire si rejeté)</label>
                                        <div class="invalid-feedback" id="motifError">Veuillez fournir un motif pour rejeter cet étudiant.</div>
                                    </div>
                    
                                    <div class="d-flex justify-content-center gap-4">
                                        <button type="submit" name="action" value="valider" class="btn btn-custom btn-validate shadow">
                                            ✅ Valider
                                        </button>
                                        <button type="submit" name="action" value="rejeter" id="rejectBtn" class="btn btn-custom btn-reject shadow">
                                            ❌ Rejeter
                                        </button>
                                    </div>
                                </form>
