...
<script>
    ...
    $(document).ready(function () {
        $('#etudiant-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin-filiere.filiere.licenceExcellence.etudiants.index',['filiere' => $filiere->id]) }}",
            columns: [
                {
                    data: null,
                    name: 'nom',
            ...
            drawCallback: function () {
                $('#etudiant-table_paginate .pagination li').each(function() {
                    ...
                    var href = "{{ route('admin-filiere.filiere.licenceExcellence.etudiants.index',['filiere' => $filiere->id]) }}?page=" + pageNum;
            ...
            buttons: [
                ...
                //         form.method = 'POST';
                //         form.action = '{{ route('admin-filiere.filiere.licenceExcellence.etudiants.excel.download', ['filiere' => $filiere->id]) }}';
                ...
                //     action: function () {
                //         window.location.href = "{{ route('admin-filiere.filiere.licenceExcellence.etudiants.listToselect', ['filiere' => $filiere->id]) }}";
                //     }
                // }
            ].filter(Boolean)
        });
