@extends('visiteur.layouts.master')
@section('content')
                ...
                <div class="row ">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                    <div class="card-content">
                      <h5 class="font-15">Master - Filieres</h5>
            ...
            <div class="card-statistic-4">
              <div class="align-items-center justify-content-between">
                <div class="row ">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                    <div class="card-content">
                      <h5 class="font-15">Licence - Filieres</h5>
  ...
  <div class="col-12">
    <div class="card shadow-lg border-0">
      <div class="card-header bg-gradient-primary text-white justify-content-between align-items-center">
        <h4 class="mb-0">Répartition des Candidats par Établissement</h4>
        <div class="">
            <form action="{{ route('visiteur.data.telecharger.etablissement') }}" method="POST">
            @csrf
            <button type="submit" class="btn btn-light btn-sm">
                <i class="fas fa-download"></i> Télécharger les données par établissement
            </button>
        </form>
        <form action="{{ route('visiteur.data.telecharger.filiere') }}" method="POST" class="ms-2">
            @csrf
            <button type="submit" class="btn btn-light btn-sm">
