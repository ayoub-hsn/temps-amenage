            ...
            <div class="col-lg-12">
                <div class="card shadow-lg">
                    <div class="card-header bg-primary">
                        ...
                        <a href="{{ route('sup-admin.actualite.create') }}" class="btn btn-light btn-sm">
                    ...
                    <div class="card-body">
                        @if($actualites->isEmpty())
                            <div class="alert alert-warning text-center">
                                <strong>Aucune actualité n'est disponible actuellement.</strong>
                            </div>
                        @else
                            <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="card shadow-sm rounded-lg overflow-hidden">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="{{ route('sup-admin.actualite.show', $actualite->id) }}" class="btn btn-primary btn-sm btn-block">
                                                    Voir plus
                                                </a>
                                            </div>
                                        </div>
