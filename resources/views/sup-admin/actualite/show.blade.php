                ...
                <div class="card shadow-lg rounded-lg border-0">
                    ...
                    <div class="card-body px-4 py-5">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            ...
                            <!-- Edit Button -->
                            <a href="{{ route('sup-admin.actualite.edit', $actualite->id) }}" class="btn btn-outline-success btn-sm px-4 py-2 rounded-pill" style="font-size: 1.1rem; transition: all 0.3s ease-in-out; border: 2px solid #28a745; font-weight: 600; padding-left: 20px; padding-right: 20px;">
