        ...
        <div class="calendar-wrapper">
            <div class="card calendar-card">
                ...
                <div class="calendar-header">
                    <h4><i class="fas fa-calendar-alt"></i> Créer un calendrier</h4>
                ...
                {{-- BODY --}}
                <div class="card-body">
                    <form action="{{ route('sup-admin.calendrier.store') }}" method="post">
                        @csrf
                        ...
                        <div class="calendar-section">
                            ...
                            <div class="form-group">
                                ...
                                <select name="etablissement_id" class="form-control select2 {{ $errors->has('etablissement_id') ? 'is-invalid' : '' }}" id="etablissement_id">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="datetime-local" name="date_debut_master" value="{{ old('date_debut_master') }}" class="form-control {{ $errors->has('date_debut_master') ? 'is-invalid' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="datetime-local" name="date_fin_master" value="{{ old('date_fin_master') }}" class="form-control {{ $errors->has('date_fin_master') ? 'is-invalid' : '' }}">
                                ...
                                <div class="calendar-section">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Date d’ouverture</label>
                                                <input type="datetime-local" name="date_debut_passerelle" value="{{ old('date_debut_passerelle') }}" class="form-control {{ $errors->has('date_debut_passerelle') ? 'is-invalid' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Date de fermeture</label>
                                                <input type="datetime-local" name="date_fin_passerelle" value="{{ old('date_fin_passerelle') }}" class="form-control {{ $errors->has('date_fin_passerelle') ? 'is-invalid' : '' }}">
                        ...
                        <div class="calendar-section">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Date d’ouverture</label>
                                        <input type="datetime-local" name="date_debut_bachelier" value="{{ old('date_debut_bachelier') }}" class="form-control {{ $errors->has('date_debut_bachelier') ? 'is-invalid' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Date de fermeture</label>
                                        <input type="datetime-local" name="date_fin_bachelier" value="{{ old('date_fin_bachelier') }}" class="form-control {{ $errors->has('date_fin_bachelier') ? 'is-invalid' : '' }}">
                        ...
                        {{-- SUBMIT BUTTON --}}
                        <div class="mt-5 mb-3">
                            <button class="btn calendar-btn w-100 py-3">Créer le calendrier</button>
                        </div>
