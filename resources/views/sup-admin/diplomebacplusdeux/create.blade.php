            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header" style="justify-content: space-between;">
                        ...
                        <a href="{{route('sup-admin.diplomebacplusdeux.index')}}" class="btn btn-primary">Liste des diplomes du Bac+2</a>
                    </div>
                    <div class="card-body">
                        <form action="{{route('sup-admin.diplomebacplusdeux.store')}}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
