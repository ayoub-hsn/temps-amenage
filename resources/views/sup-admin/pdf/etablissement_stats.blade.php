    ...
    <table>
        <thead>
            <tr>
                ...
                <th>Établissement</th>
                <th>Master</th>
                <th>Licence(Accès S5)</th>
                <th>Licence(Accès S1)</th>
                <th>Total</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($etablissementStats as $index => $etab)
                <tr>
                    ...
                    <td>{{ $etab->student_bachelier_count }}</td>
                    <td>{{ $etab->student_master_count + $etab->student_passerelle_count + $etab->student_bachelier_count }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
