            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header" style="justify-content: space-between;">
                        <h4>Modifier la province</h4>
                        <a href="{{route('sup-admin.province.index')}}" class="btn btn-primary">Liste des provinces</a>
                    </div>
                    <div class="card-body">
                        <form action="{{route('sup-admin.province.update',['province' => $province->id])}}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nom" value="{{ old('nom',$province->nom) }}" class="form-control {{ $errors->has('nom') ? 'is-invalid' : '' }}" id="nom">
                                        @if($errors->has('nom'))
