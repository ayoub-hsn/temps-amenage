        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('sup-admin.etablissement.store')}}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
                                   <div class="row">
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nom_abrev" value="{{old('nom_abrev')}}" class="form-control {{ $errors->has('nom_abrev') ? 'is-invalid' : '' }}">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nom" value="{{old('nom')}}" class="form-control {{ $errors->has('nom') ? 'is-invalid' : '' }}">
                                            @if($errors->has('nom'))
                                                <div class="invalid-feedback">
                                                    {{ $errors->first('nom') }}
                                                </div>
