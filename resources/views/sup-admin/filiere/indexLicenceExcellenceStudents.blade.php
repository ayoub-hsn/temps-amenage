...
<script>
    ...
    $(document).ready(function () {
        $('#etudiant-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('sup-admin.etablissement.filiere.passerelle.etudiants',['filiere' => $filiere->id]) }}",
            columns: [
                { 
                    data: null,
                    name: 'nom',
            ...
            drawCallback: function () {
                $('#etudiant-table_paginate .pagination li').each(function() {
                    ...
                    var href = "{{ route('sup-admin.etablissement.filiere.passerelle.etudiants',['filiere' => $filiere->id]) }}?page=" + pageNum;
