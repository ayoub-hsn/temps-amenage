                    ...
                    <div class="filiere-grid">
                        ...
                        <div class="filiere-tile">
                            ...
                            <div class="filiere-footer">
                                ...
                                <a href="{{ route('sup-admin.payment.licence.filiere.students', $filiere->id) }}"
...
<script>
    $(document).ready(function() {
        ...
        $('#btn-check-all').on('click', function() {
            ...
            $.ajax({
                url: "{{ route('sup-admin.payment.licence.checkAll') }}",
                type: "POST",
                data: {
                ...
                success: function(startResponse) {
                    ...
                    let interval = setInterval(function() {
                        ...
                        $.ajax({
                            url: "{{ route('sup-admin.payment.licence.checkAllProgress') }}",
                            type: "GET",
