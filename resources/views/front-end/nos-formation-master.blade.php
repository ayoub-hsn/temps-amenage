...
<title>Université Hassan 1er - Formation Initiale en Temps Aménagé - Settat - Master</title>
        ...
        <div class="date-banner-container">
            <div class="date-banner">
                ...
                <div class="banner-content">
                    <strong>📢 Période d’inscription Master :</strong>
                    <span class="start-date">
                        {{ \Carbon\Carbon::parse($calendrier->date_debut_master)->translatedFormat('d F Y à H:i') }}
                    </span>
                    <span> — </span>
                    <span class="end-date">
                        {{ \Carbon\Carbon::parse($calendrier->date_fin_master)->translatedFormat('d F Y à H:i') }}
                    </span>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const startDateStr = "{{ $calendrier->date_debut_master ?? '' }}";
        const endDateStr = "{{ $calendrier->date_fin_master ?? '' }}";
