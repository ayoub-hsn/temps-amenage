...
<title>Université Hassan 1er - Formation Initiale en Temps Aménagé - Settat - Licences (Accès S1)</title>
...
<main class="formation-main">
        ...
        <div class="date-banner-container">
            <div class="date-banner">
                ...
                <div class="banner-content">
                    <strong>📢 Période d’inscription Licence (Accès S1) :</strong>
                    <span class="start-date">
                        {{ \Carbon\Carbon::parse($calendrier->date_debut_bachelier )->translatedFormat('d F Y à H:i') }}
                    </span>
                    <span> — </span>
                    <span class="end-date">
                        {{ \Carbon\Carbon::parse($calendrier->date_fin_bachelier )->translatedFormat('d F Y à H:i') }}
                    </span>
    ...
    <div class="welcome-section text-center">
        ...
        <p class="lead mt-3 mb-5">
            @if ($etablissement->id == 1 || $etablissement->id == 9)
            ...
            @forelse($filieresLicence as $filiere)
                <div class="formation-card">
                    ...
                    <div class="d-flex flex-column gap-3 align-items-center">
                        ...
                        <a href="{{ route('bachelier.nosformationChoisen', ['id' => $filiere->id]) }}" class="btn-preinscription">
                            📥 Préinscription
                        </a>
                    </div>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const startDateStr = "{{ $calendrier->date_debut_bachelier  ?? '' }}";
        const endDateStr = "{{ $calendrier->date_fin_bachelier  ?? '' }}";
