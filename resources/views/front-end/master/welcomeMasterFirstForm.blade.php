...
<div class="application-container">
    <div class="application-header">
        <h1 class="application-title">Postuler au Master</h1>
        <p class="application-subtitle">Merci de remplir le formulaire ci-dessous pour postuler au programme de Master.</p>
    </div>
    @if (Session::has('error_student_exist'))
        <div class="alert alert-danger">{{ Session::get('error_student_exist') }}</div>
    @endif
    <form action="{{ route('welcomeMaster.apply',['etablissement' => $etablissement->id]) }}" method="POST" class="application-form">
        @csrf
