...
class CheckMasterReceiptJob implements ShouldQueue
{
    ...
    public function __construct(PaymentMaster $payment)
    {
    ...
    public function handle()
    {
        try {
            ...
            $payment = PaymentMaster::find($this->payment->id);
            ...
            foreach ($lines as $line) {
                ...
                foreach ($matches[0] as $raw) {
                    ...
                    */
                    ...
                    $numberPool[] = (string) round($value,2);
                }
            }
            ...
            */
            ...
            if (!empty($numberPool)) {
                ...
                $numberPool = array_filter($numberPool, function ($v) {
                    return is_numeric($v);
                });

                // convert everything to integer
                $numberPool = array_map(function ($v) {
                    return (int) round($v);
                }, $numberPool);
