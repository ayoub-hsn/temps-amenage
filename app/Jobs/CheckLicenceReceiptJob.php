...
class CheckLicenceReceiptJob implements ShouldQueue
{
    ...
    public function __construct(PaymentPasserelle $payment)
    {
    ...
    public function handle()
    {
        try {
            ...
            $payment = PaymentPasserelle::find($this->payment->id);
