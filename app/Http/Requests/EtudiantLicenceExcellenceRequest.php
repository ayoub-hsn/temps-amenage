...
class EtudiantLicenceExcellenceRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'path_diplomedeug.file' => 'Le fichier licence doit être un fichier valide.',
            'path_diplomedeug.mimes' => 'Le fichier licence doit être au format JPEG ou PNG.',
            'path_diplomedeug.max' => 'Le fichier licence ne doit pas dépasser 300 Ko.',
