...
class EtudiantLicenceExcellenceRequest extends FormRequest
{
    /**
   ...
   public function rules()
    {        
        return [
            ...
            'diplomedeug' => 'required',
            'mentiondeug' => 'required',
            'specialitedeug' => 'required|min:2|max:200',
            'etblsmtdeug' => 'required|min:2|max:200',
            'ville_etablissement_deug' => 'required|min:2|max:150',
            'date_obtention_deug' => 'required',
            'moyenne_deug'   => 'required',
    ...
    public function messages()
    {
        return [
            ...
            'diplomedeug.required' => 'Le diplôme est obligatoire.',
            'mentiondeug.required' => 'La mention est obligatoire.',
            'specialitedeug.required' => 'La spécialité est obligatoire.',
            'specialitedeug.min' => 'La spécialité doit contenir au moins 2 caractères.',
            'specialitedeug.max' => 'La spécialité ne doit pas dépasser 200 caractères.',
            'date_optention_diplome.required' => "La date d'obtention du diplome est obligatoire.",
            'moyenne_deug.required' => 'La moyenne du diplome est obligatoire.',
